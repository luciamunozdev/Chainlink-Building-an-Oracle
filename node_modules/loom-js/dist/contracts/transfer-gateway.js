...
var TransferGateway = /** @class */ (function (_super) {
    ...
    TransferGateway.prototype.withdrawalReceiptAsync = function (owner) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var tgWithdrawReceiptReq, result, receipt;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, receipt ? unmarshalWithdrawalReceipt(receipt) : null];
                }
            });
        });
    };
     ...
     */
    TransferGateway.prototype.getLocalAccountInfoAsync = function (owner) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, resp, receipt, amount;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new transfer_gateway_pb_1.TransferGatewayGetLocalAccountInfoRequest();
                        req.setOwner(owner.MarshalPB());
                        return [4 /*yield*/, this.staticCallAsync('GetLocalAccountInfo', req, new transfer_gateway_pb_1.TransferGatewayGetLocalAccountInfoResponse())];
                    case 1:
                        resp = _a.sent();
                        receipt = resp.getWithdrawalReceipt();
                        amount = resp.getTotalWithdrawalAmount();
                        return [2 /*return*/, {
                                withdrawalReceipt: receipt ? unmarshalWithdrawalReceipt(receipt) : null,
                                totalWithdrawalAmount: amount ? big_uint_1.unmarshalBigUIntPB(amount) : new bn_js_1.default(0),
     ...
     */
    TransferGateway.prototype.getContractMappingAsync = function (from) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var request, response;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new transfer_gateway_pb_1.TransferGatewayGetContractMappingRequest();
                        request.setFrom(from.MarshalPB());
                        return [4 /*yield*/, this.staticCallAsync('GetContractMapping', request, new transfer_gateway_pb_1.TransferGatewayGetContractMappingResponse())];
                    case 1:
                        response = _a.sent();
                        ...
                        return [2 /*return*/, {
                                to: address_1.Address.UnmarshalPB(response.getMappedAddress()),
     ...
     */
    TransferGateway.prototype.getStateAsync = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response, state, maxTotalDailyWithdrawalAmount, maxPerAccountDailyWithdrawalAmount, lastWithdrawalLimitResetTime, totalWithdrawalAmount;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.staticCallAsync('GetState', new transfer_gateway_pb_1.TransferGatewayStateRequest(), new transfer_gateway_pb_1.TransferGatewayStateResponse())];
                    case 1:
                        response = _a.sent();
                        state = response.getState();
                        if (!state) {
                            return [2 /*return*/, {
                                    maxTotalDailyWithdrawalAmount: new bn_js_1.default(0),
                                    maxPerAccountDailyWithdrawalAmount: new bn_js_1.default(0),
                                    lastWithdrawalLimitResetTime: new Date(0),
                                    totalWithdrawalAmount: new bn_js_1.default(0)
                                }];
                        }
                        maxTotalDailyWithdrawalAmount = state.getMaxTotalDailyWithdrawalAmount();
                        maxPerAccountDailyWithdrawalAmount = state.getMaxPerAccountDailyWithdrawalAmount();
                        lastWithdrawalLimitResetTime = state.getLastWithdrawalLimitResetTime();
                        totalWithdrawalAmount = state.getTotalWithdrawalAmount();
                        return [2 /*return*/, {
                                maxTotalDailyWithdrawalAmount: maxTotalDailyWithdrawalAmount
                                    ? big_uint_1.unmarshalBigUIntPB(maxTotalDailyWithdrawalAmount)
                                    : new bn_js_1.default(0),
                                maxPerAccountDailyWithdrawalAmount: maxPerAccountDailyWithdrawalAmount
                                    ? big_uint_1.unmarshalBigUIntPB(maxPerAccountDailyWithdrawalAmount)
                                    : new bn_js_1.default(0),
                                lastWithdrawalLimitResetTime: lastWithdrawalLimitResetTime
                                    ? new Date(lastWithdrawalLimitResetTime * 1000)
                                    : new Date(0),
                                totalWithdrawalAmount: totalWithdrawalAmount
                                    ? big_uint_1.unmarshalBigUIntPB(totalWithdrawalAmount)
                                    : new bn_js_1.default(0)
                            }];
                }
            });
...
function unmarshalWithdrawalReceipt(receipt) {
    var tokenId;
    var tokenAmount;
    var value;
    var tokenKind = receipt.getTokenKind();
    switch (tokenKind) {
        case transfer_gateway_pb_1.TransferGatewayTokenKind.ERC721:
    ...
    return {
        ...
        tokenContract: receipt.getTokenContract()
            ? address_1.Address.UnmarshalPB(receipt.getTokenContract())
            : undefined,
        tokenKind: tokenKind,
        tokenId: tokenId,
        tokenAmount: tokenAmount,
