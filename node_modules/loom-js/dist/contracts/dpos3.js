                    ...
                    case 1:
                        ...
                        return [2 /*return*/, result.getCandidatesList().map(function (candidate) {
                                ...
                                return {
                                    ...
                                    delegationTotal: s && s.getDelegationTotal() ? big_uint_1.unmarshalBigUIntPB(s.getDelegationTotal()) : new bn_js_1.default(0),
                                    slashPercentage: s && s.getSlashPercentage() ? big_uint_1.unmarshalBigUIntPB(s.getSlashPercentage()) : new bn_js_1.default(0),
                                    whitelistAmount: s && s.getWhitelistAmount() ? big_uint_1.unmarshalBigUIntPB(s.getWhitelistAmount()) : new bn_js_1.default(0),
