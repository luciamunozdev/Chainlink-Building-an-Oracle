...
var BscTransferGateway = /** @class */ (function (_super) {
    tslib_1.__extends(BscTransferGateway, _super);
    function BscTransferGateway() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BscTransferGateway.createAsync = function (client, callerAddr) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var contractAddr;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.getContractAddressAsync('bsc-gateway')];
                    case 1:
                        contractAddr = _a.sent();
                        if (!contractAddr) {
                            throw Error('Failed to resolve contract address for BscTransferGateway');
                        }
                        return [2 /*return*/, new BscTransferGateway({ contractAddr: contractAddr, callerAddr: callerAddr, client: client })];
                }
            });
        });
    };
     ...
     *          request.
     */
    BscTransferGateway.prototype.withdrawLoomCoinAsync = function (amount, mainnetLoomcoinAddress, recipient) {
    ...
    return BscTransferGateway;
}(transfer_gateway_1.TransferGateway));
exports.BscTransferGateway = BscTransferGateway;
//# sourceMappingURL=bsc-gateway.js.map